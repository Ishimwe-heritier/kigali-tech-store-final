  ...
  <div class="container mx-auto px-4 py-20 flex justify-center">
    <div class="w-full max-w-md bg-white p-10 rounded-3xl shadow-sm border border-gray-100">
      <div class="text-center mb-10">
        ...
        <p class="text-gray-500">Login to your Kigali Tech account</p>
      </div>
      ...
      <div class="mt-8 text-center text-gray-500">
        ...
        <RouterLink to="/register" class="text-rwanda-blue font-bold hover:underline">Register now</RouterLink>
      </div>
    </div>
  </div>
</template>
